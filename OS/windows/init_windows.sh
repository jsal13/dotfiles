...
choco install -y 7zip adobereader audacity calibre googlechrome conemu deluge discord firacode gimp minecraft obs-studio paint.net slack spotify spybot steam vlc vscode
