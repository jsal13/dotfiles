...
choco install -y 7zip adobereader audacity calibre googlechrome conemu deluge discord firacode gimp minecraft obs-studio paint.net rainmeter slack spotify spybot steam vlc vscode
