...
code --install-extension octref.vetur# !/bin/bash 
...
sudo apt install curl jq -y
sudo apt-get install -y curl git gdebi-core vim ack-grep jq zsh obs-studio terminator peek default-jre default-jdk libgl1-mesa-dri:i386 libgl1-mesa-glx:i386
...
code --install-extension peterjausovec.vscode-doc# !/bin/bash 
...
ker
code --install-extension esbenp.prettier-vscode# !/bin/bash 
...
code --install-extension formulahendry.code-runne# !/bin/bash 
